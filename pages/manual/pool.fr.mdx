...
Le dessin ci-dessous montre a quoi ressemble une pool sur ZooKeeper. Vous trouverez les explications pour chaque section en  This is what a ZooKeeper pool looks like; you can see the explanation for each section by checking the text that matches the numbers in the image below.
