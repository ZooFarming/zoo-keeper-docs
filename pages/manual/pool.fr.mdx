...
7. Sous la valeur de jetons WSLP fournie, vous avez le choix entre faire un dépôt de WSLP pour la première fois ou bien d'en rajouter si vous avez déjà contribué à cette pool. En sélectionnant "faire un    Under the locked value of your WSLP you can either choose to deposit WSLP for the first time or, if you have already contributed to the pool, you can add more WSLP to your current stake. Selecting either "Deposit WSLP Token" or "Top-Up" will provide more options to help you enhance your rewards.  These are detailed below:
