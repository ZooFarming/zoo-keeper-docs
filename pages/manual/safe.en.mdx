...
My Safe is an area which contains all your ZOONFTs, both ZooBoosters and Keepsakes. Each ZOONFT section is easily accessible to select on the first screen, or by switching from one to another using the top bar menu.
